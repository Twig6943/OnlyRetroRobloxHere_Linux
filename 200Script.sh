...
#Download ORRH
aria2c https://archive.org/download/only-retro-roblox-here-v-1.0.3.0.7z/only-retro-roblox-here-v-1.0.3.0.7z_archive.torrent --dir=/home/$USER/Downloads --seed-time=0
